...
# 2次元正規分布
draw_gauss(x,y, gauss3d, "lightblue", "gauss3d_同時", "graphs/gauss2d.png")

# f(x,[0,0.01])
draw_gauss(x,yy, gauss3d,  "lightblue", "gauss3d_P(X=x, Y=0)", "graphs/gauss_1d_x.png")

# f([0,0.1], x)
draw_gauss(xx,y, gauss3d, "lightblue", "gauss3ld_P(X=0, Y=y)", "graphs/gauss_1d_y.png")

draw_gauss(xx,y, gauss3d_y, "blue", "gauss3d_周辺_y", "graphs/gauss_2d_marginal_x.png")
draw_gauss(x,yy, gauss3d_x, "red", "gauss3d_周辺_x", "graphs/gauss_2d_marginal_y.png")
